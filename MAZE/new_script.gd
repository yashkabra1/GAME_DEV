...
func gen_maze(frame):
    ...
    $MazeGenerator.number_of_rows = frame.size.y / cell_size
    $MazeGenerator.number_of_columns = frame.size.x / cell_size
...
func place_player(maze):
    ...
    var player = get_node("OuterFrame/CharacterBody2D")
    var player_sprite = get_node("OuterFrame/CharacterBody2D/Sprite2D")
